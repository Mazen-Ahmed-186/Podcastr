            ...
            <div className="flex flex-col justify-center max-md:items-center">
                <div className="flex flex-col gap-2.5">
                    <figure className="flex gap-2 max-md:justify-center">
                        <Image
                            ...
                            alt="verified"
                        />
                        <h2 className="text-[14px] leading-normal font-medium text-white-2">
                            Verified Creator
                        </h2>
                    </figure>
                ...
                <figure className="flex gap-3 py-6">
                    <Image
                        ...
                        alt="headphones"
                    />
                    <h2 className="text-[16px] leading-normal font-semibold text-white-1">
                ...
                {podcastData?.podcasts.length > 0 && (
                    <Button
                        ...
                        className="text-[16px] leading-normal bg-orange-1 font-extrabold text-white-1"
                    >
                        <Image
                            src="/icons/Play.svg"
                            width={20}
